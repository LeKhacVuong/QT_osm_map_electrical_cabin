...
public:
    ...
    void setupUi(QDialog *case_setting)
    {
        ...
        pushButton_confirm->setGeometry(QRect(290, 240, 81, 31));
        QFont font;
        ...
        pushButton_cancel->setGeometry(QRect(390, 240, 81, 31));
        ...
        widget1 = new QWidget(case_setting);
        widget1->setObjectName("widget1");
        widget1->setGeometry(QRect(0, 0, 2, 2));
        verticalLayout_4 = new QVBoxLayout(widget1);
        verticalLayout_4->setObjectName("verticalLayout_4");
        verticalLayout_4->setContentsMargins(0, 0, 0, 0);
        widget2 = new QWidget(case_setting);
        widget2->setObjectName("widget2");
        widget2->setGeometry(QRect(20, 13, 451, 221));
        ...
        label_caseName = new QLabel(widget2);
        ...
        lineEdit_threadHold = new QLineEdit(widget2);
        ...
        radioButton_auto = new QRadioButton(widget2);
        ...
        radioButton_manual = new QRadioButton(widget2);
        ...
        stackedWidget = new QStackedWidget(widget2);
        ...
        layoutWidget = new QWidget(page_1_manual);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(0, 0, 449, 39));
        ...
        radioButton_of = new QRadioButton(layoutWidget);
        ...
        widget3 = new QWidget(page_2_auto);
        widget3->setObjectName("widget3");
        widget3->setGeometry(QRect(0, 0, 441, 84));
        ...
        timeEdit_stop = new QTimeEdit(widget3);
        ...
        lineEdit_syncTime = new QLineEdit(widget3);
